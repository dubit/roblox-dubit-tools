...
local apiDumpSuccess, apiDump = pcall(function()
	return require(script["generated-api-dump"])
end)

if not apiDumpSuccess then
	warn(`DebugTools was unable to fetch API dump - is the generated-api-dump file empty?`)
	apiDump = { Classes = {} }
end
